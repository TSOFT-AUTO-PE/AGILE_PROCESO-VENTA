...
public class LoginPageObject {
    ...
    public static String inputuserLocator        = "/html/body/my-app/main/numerosasociados/div/div/div/div[2]/div/form/div[1]/input";
    public static String detailuserLocator       = "/html/body/my-app/main/numerosasociados/div/div/div/div[4]/table/tbody/tr/td[8]/a";
    public static String tokenuserLocator        = "/html/body/my-app/main/my-numerosasociadosdetail/div/div/div/div/form/table/tbody/tr[5]/td[2]";
    public static String ingresartokenLocator    = "/html/body/my-app/main/nobiometric/div[2]/div/div/form/div[3]/input";
